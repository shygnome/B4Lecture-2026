...
* **軌跡のアニメーション**
    ![軌跡のアニメーション](data/output/trajectory_animation.webm)
  * より直感的に動きを理解するために、軌跡のアニメーションも生成した。
  * アニメーションを通して、ID 6, 13 は安定して同一人物を追跡できていることがわかった。
  * また、ID 7 の軌跡が途切れ、ID 44 の軌跡が始まる様子や、その後 ID 7 が別の選手に割り当てられる様子もよりわかりやすく確認できた。
---

## 課題2：特徴量の改変

* **追加した特徴量**
  * 選手が極端な速度になったり、速度の急激な変化があったりしていないかを確認するため、各フレームにおける選手の速度（pixels/frame）と加速度（pixels/frame^2）を特徴量として追加した。
  * 視覚的な確認のため、速度の時系列グラフを描画した。
   ![速度のグラフ](data/output/speed_subplots.png)
* **計算方法**
